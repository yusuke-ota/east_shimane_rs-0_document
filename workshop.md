...
<!-- 1. 参照(生ポインタ)は固定長なので、スタック上に存在する
2. スタック上に存在する変数(参照)は、所有権移動時にコピーされる

-> 所有権システムは可変長変数と固定長変数の所有権移動の2つに抽象化できる

[固定長型でのコード](https://play.rust-lang.org/?version=stable&mode=debug&edition=2018&gist=9da0e53cc4d2674815f9ca40748b7095)

[可変長型でのコード](https://play.rust-lang.org/?version=stable&mode=debug&edition=2018&gist=150383a38e5fc8fffb6305869663331a) -->
